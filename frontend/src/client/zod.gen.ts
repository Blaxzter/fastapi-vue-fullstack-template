...
export const zProjectCreate = z.object({
  ...
  description: z.optional(z.union([z.string().max(1000), z.null()])),
  status: z.optional(
    z.enum(['active', 'archived']).register(z.globalRegistry, {
      description: 'Project status',
    }),
  ),
  owner_id: z.optional(z.union([z.uuid(), z.null()])),
})
...
export const zProjectUpdate = z.object({
  name: z.optional(z.union([z.string().min(1).max(200), z.null()])),
  description: z.optional(z.union([z.string().max(1000), z.null()])),
  status: z.optional(z.union([z.enum(['active', 'archived']), z.null()])),
  owner_id: z.optional(z.union([z.uuid(), z.null()])),
})
...
export const zTaskCreate = z.object({
  ...
  description: z.optional(z.union([z.string().max(2000), z.null()])),
  status: z.optional(
    z.enum(['todo', 'in_progress', 'done']).register(z.globalRegistry, {
  ...
  priority: z
    ...
    .default(3),
  due_date: z.optional(z.union([z.iso.date(), z.null()])),
})
...
export const zTaskUpdate = z.object({
  title: z.optional(z.union([z.string().min(1).max(200), z.null()])),
  description: z.optional(z.union([z.string().max(2000), z.null()])),
  status: z.optional(z.union([z.enum(['todo', 'in_progress', 'done']), z.null()])),
  priority: z.optional(z.union([z.int().gte(1).lte(5), z.null()])),
  due_date: z.optional(z.union([z.iso.date(), z.null()])),
  project_id: z.optional(z.union([z.uuid(), z.null()])),
})
...
export const zProjectsListProjectsData = z.object({
  ...
  query: z.optional(
    z.object({
      ...
      owner_id: z.optional(z.union([z.uuid(), z.null()])),
      sort_by: z.optional(z.enum(['name', 'status', 'created_at', 'updated_at'])),
      sort_dir: z.optional(z.enum(['asc', 'desc'])),
    }),
  ),
})
...
export const zTasksListTasksData = z.object({
  ...
  query: z.optional(
    z.object({
      ...
      limit: z.optional(z.int()).default(50),
      search: z.optional(z.union([z.string(), z.null()])),
      task_status: z.optional(z.union([z.string(), z.null()])),
      project_id: z.optional(z.union([z.uuid(), z.null()])),
      sort_by: z.optional(
        z.enum(['title', 'status', 'priority', 'due_date', 'created_at', 'updated_at']),
      ),
      sort_dir: z.optional(z.enum(['asc', 'desc'])),
    }),
  ),
